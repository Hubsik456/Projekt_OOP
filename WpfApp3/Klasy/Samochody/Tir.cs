...
namespace WpfApp3.Klasy
{
    internal class Tir : Samochód
    {
        ...
        // Konstruktory
        public Tir(string _ID, string _Źródło, string _Marka, string _Model, string _Kolor, Rodzaj_Napędu _Napęd, Skrzynia_Biegów _Skrzynia_Biegów) : base(_ID, _Źródło, _Marka, _Model, _Kolor, _Napęd, _Skrzynia_Biegów)
        {
            Typ = "Tir";
        }
